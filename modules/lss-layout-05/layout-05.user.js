(function () {
    $('head').append('<link href="https://code.jquery.com/ui/1.10.4/themes/ui-lightness/jquery-ui.css" rel="stylesheet"></script>');
    $('body').prepend('<style type="text/css" id="lss-layout-03-style">' +
    ...
    $('#missions-panel-body').prev().attr('id', 'mission_buttons_outer').detach().appendTo('#content');
