user_id = document.getElementById("navbar_profile_link").href;
user_id = user_id.replace("https://www.leitstellenspiel.de/profile/","");
user_id = user_id.replace("https://www.missionchief.com/profile/","");
user_id = user_id.replace("https://www.meldkamerspel.com/profile/","");
...
function setCookies() {
  gesamtcredits = NaN;
  dienstgrad = NaN;
  content = document.getElementsByClassName("lightbox_iframe")[0].contentWindow.document.body.innerHTML.replace(/<\/?[^>]+>/gi, "");
