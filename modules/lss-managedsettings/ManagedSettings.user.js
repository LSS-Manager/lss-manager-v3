(function(I18n, $) {
    ...
    I18n.translations.de_DE.lssm.managedsettings = {
        ...
        text1:
            'Hier kannst du Einstellungen für deine aktivierten Plugins vornehmen',
        text2: '',
        ...
        reset_hint:
            'Möchtest du die Einstellungen dieses Moduls wirklich auf die Standardwerte zurücksetzen?',
        reset_success:
        ...
        export_hint:
            'Bitte beachte, dass nur bereits gespeicherte Einstellungen von momentan aktivierten Module exportiert werden können.',
        import_success:
    ...
    I18n.translations.cs_CZ.lssm.managedsettings = {
        ...
        reset_hint:
            'Opravdu chcete obnovit nastavení tohoto modulu na výchozí hodnoty?',
        reset_success:
            'Nastavení úspěšně obnovte. Chcete-li, aby fungovaly, je třeba stránku znovu načíst.',
        export_success: 'Nastavení bylo úspěšně exportováno',
        export_hint:
            'Upozorňujeme, že lze exportovat pouze dříve uložená nastavení aktuálně aktivovaných modulů.',
        import_success:
            'Nastavení byla úspěšně importována. Chcete-li, aby fungovaly, je třeba stránku znovu načíst.',
        import_missmatch:
            'Soubor pro čtení již bohužel již není kompatibilní s aktuální verzí LSSM.',
        import_fail:
            'Chyba: Při importu souboru došlo k chybě: <strong> {0} </strong>. Prosím informujte vývojáře.',
    };
    ...
    I18n.translations.es_ES.lssm.managedsettings = {
        ...
        reset_hint:
            '¿Está seguro de que desea restablecer la configuración de este módulo a los valores predeterminados?',
        reset_success:
            'Reajuste con éxito los ajustes. Necesitas recargar la página para que funcione.',
        export_success: 'Configuraciones exportadas con éxito',
        export_hint:
            'Tenga en cuenta que sólo se pueden exportar los ajustes guardados anteriormente de los módulos actualmente activados.',
        import_success:
            'La configuración se ha importado correctamente. Necesitas recargar la página para que funcione.',
        import_missmatch:
            'Lamentablemente, el archivo de lectura ya no es compatible con la versión actual de LSSM.',
        import_fail:
    ...
    I18n.translations.pt_PT.lssm.managedsettings = {
        ...
        reset_hint:
            'Tem a certeza de que pretende redefinir as definições deste módulo para os valores predefinidos?',
        reset_success:
            'Redefinir com sucesso as definições. Tens de recarregar a página para que funcionem.',
        export_success: 'Configurações exportadas com sucesso',
        export_hint:
            'Por favor, note que apenas configurações previamente guardadas de módulos atualmente ativados podem ser exportadas.',
        import_success:
            'As configurações foram importadas com sucesso. Tens de recarregar a página para que funcionem.',
        import_missmatch:
            'Infelizmente, o ficheiro de leitura já não é compatível com a versão atual do LSSM.',
        import_fail:
    ...
    I18n.translations.pl_PL.lssm.managedsettings = {
        ...
        reset_hint:
            'Czy na pewno chcesz przywrócić ustawienia tego modułu do wartości domyślnych?',
        reset_success:
            'Pomyślnie zresetuj ustawienia. Aby strona działała, należy ją ponownie załadować.',
        export_success: 'Sukcesywnie eksportowane ustawienia',
        export_hint:
            'Należy pamiętać, że tylko wcześniej zapisane ustawienia aktualnie aktywowanych modułów mogą być eksportowane.',
        import_success:
            'Ustawienia zostały pomyślnie zaimportowane. Aby strona działała, należy ją ponownie załadować.',
        import_missmatch:
            'Plik do odczytu nie jest już niestety kompatybilny z aktualną wersją LSSM.',
        import_fail:
            'Błąd: Wystąpił błąd podczas importowania pliku: <strong> {0} </strong>. Proszę poinformować dewelopera.',
    };
    ...
    I18n.translations.sv_SE.lssm.managedsettings = {
        ...
        reset_hint:
            'Är du säker på att du vill återställa inställningarna för den här modulen till standardvärdena?',
        reset_success:
            'Återställ inställningarna. Du måste ladda om sidan för att få dem att fungera.',
        export_success: 'Exporterade inställningar lyckades',
        export_hint:
            'Observera att endast tidigare sparade inställningar för för närvarande aktiverade moduler kan exporteras.',
        import_success:
            'Inställningarna importerades framgångsrikt. Du måste ladda om sidan för att få dem att fungera.',
        import_missmatch:
            'Den inlästa filen är tyvärr inte längre kompatibel med den aktuella versionen av LSSM.',
        import_fail:
            'Fel: Ett fel inträffade vid import av filen: <strong> {0} </strong>. Informera en utvecklare.',
    };
    ...
    I18n.translations.da_DK.lssm.managedsettings = {
        ...
        reset_hint:
            'Er du sikker på, at du vil nulstille indstillingerne for dette modul til standardværdier?',
        reset_success:
            'Nulstil indstillingerne. Du skal genindlæse siden for at få dem til at fungere.',
        export_success: 'Eksporterede indstillinger',
        export_hint:
            'Bemærk, at kun tidligere gemte indstillinger af aktuelt aktiverede moduler kan eksporteres.',
        import_success:
            'Indstillingerne blev importeret med succes. Du skal genindlæse siden for at få dem til at fungere.',
        import_missmatch:
            'Den indlæste fil er desværre ikke længere kompatibel med den aktuelle version af LSSM.',
        import_fail:
            'Fejl: Der opstod en fejl under import af filen:<strong> {0} </strong>. Fortæl en udvikler.',
    };
    ...
    I18n.translations.nb_NO.lssm.managedsettings = {
        ...
        reset_hint:
            'Er du sikker på at du vil tilbakestille innstillingene for denne modulen til standardverdiene?',
        reset_success:
            'Tilbakestill innstillingene. Du må laste inn siden på nytt for å få dem til å fungere.',
        export_success: 'Eksporterte innstillinger',
        export_hint:
            'Vær oppmerksom på at bare tidligere lagrede innstillinger for aktuelt aktiverte moduler kan eksporteres.',
        import_success:
            'Innstillingene ble importert. Du må laste inn siden på nytt for å få dem til å fungere.',
        import_missmatch:
            'Innlesningsfilen er dessverre ikke lenger kompatibel med den nåværende versjonen av LSSM.',
        import_fail:
    ...
    I18n.translations.it_IT.lssm.managedsettings = {
        ...
        text1:
            'Qui è possibile modificare le impostazioni dei plugin attivati.',
        text2: '',
        save: 'Salva & Chiudi',
        ...
        reset_success:
            'Ripristinare con successo le impostazioni. È necessario ricaricare la pagina per farle funzionare.',
        ...
        import_success:
            'Le impostazioni sono state importate con successo. È necessario ricaricare la pagina per farle funzionare.',
        import_missmatch:
            'Il file letto non è purtroppo più compatibile con la versione corrente di LSSM.',
        import_fail:
            "Errore: Si è verificato un errore durante l'importazione del file: <strong> {0} </strong>. Si prega di informare uno sviluppatore.",
    };

    I18n.translations.tr_TR.lssm.managedsettings = {
        title: 'LSSM Ayarları',
        text1:
            'Burada etkinleştirilen eklentilerinizin ayarlarını değiştirebilirsiniz.',
        text2: '',
        save: 'Kaydet kapat',
        ...
        reset_hint:
            'Bu modülün ayarlarını varsayılan değerlere sıfırlamak istediğinizden emin misiniz?',
        reset_success:
            'Ayarları başarıyla sıfırlayın. Çalışmaları için sayfayı yeniden yüklemeniz gerekir.',
        export_success: 'Ayarlar başarıyla dışa aktarıldı',
        export_hint:
            'Geçerli olarak etkinleştirilmiş modüllerin yalnızca önceden kaydedilmiş ayarlarının dışa aktarılabileceğini lütfen unutmayın.',
        import_success:
            'Ayarlar başarıyla içe aktarıldı. Çalışmaları için sayfayı yeniden yüklemeniz gerekir.',
        import_missmatch:
            "Okuma dosyası maalesef artık LSSM'nin mevcut sürümüyle uyumlu değil.",
        import_fail:
            'Hata: Dosya içe aktarılırken bir hata oluştu: <strong> {0} </strong>. Lütfen bir geliştiriciyi bilgilendirin.',
    };

    I18n.translations.fr_FR.lssm.managedsettings = {
        title: 'Paramètres LSSM',
        text1:
            'Ici, vous pouvez modifier les paramètres de vos plugins activés.',
        text2: '',
        ...
        reset_hint:
            'Êtes-vous sûr de vouloir réinitialiser les paramètres de ce module aux valeurs par défaut ?',
        reset_success:
            "Réinitialiser les réglages avec succès. Vous devez recharger la page pour qu'elle fonctionne.",
        export_success: 'Paramètres exportés avec succès',
        export_hint:
            'Veuillez noter que seuls les paramètres précédemment enregistrés des modules actuellement activés peuvent être exportés.',
        import_success:
            "Les réglages ont été importés avec succès. Vous devez recharger la page pour qu'elle fonctionne.",
        import_missmatch:
            "Le fichier lu n'est malheureusement plus compatible avec la version actuelle de LSSM.",
        import_fail:
            "Erreur : Une erreur s'est produite lors de l'importation du fichier : <strong> {0} </strong>. Veuillez en informer un développeur.",
    };

    I18n.translations.ru_RU.lssm.managedsettings = {
        title: 'Настройки LSSM',
        text1:
            'Здесь вы можете изменить настройки активированных вами плагинов.',
        text2: '',
        ...
        reset_hint:
            'Вы уверены, что хотите сбросить настройки этого модуля до значений по умолчанию?',
        reset_success:
            'Успешный сброс настроек. Вам нужно перезагрузить страницу, чтобы они заработали.',
        export_success: 'Успешный экспорт настроек',
        export_hint:
            'Обратите внимание, что экспортировать можно только ранее сохраненные настройки активированных в данный момент модулей.',
        import_success:
            'Настройки были успешно импортированы. Вам нужно перезагрузить страницу, чтобы они заработали.',
        import_missmatch:
            'К сожалению, читаемый файл больше не совместим с текущей версией LSSM.',
        import_fail:
            'Ошибка: При импорте файла возникла ошибка: <strong> {0} </strong>. Пожалуйста, сообщите разработчику.',
    };
    ...
    I18n.translations.uk_UA.lssm.managedsettings = {
        ...
        reset_hint:
            'Ви впевнені, що хочете відновити настройки цього модуля до значень за замовчуванням?',
        reset_success:
            'Установки вдало скинули. Вам потрібно перезавантажити сторінку, щоб змусити їх працювати.',
        export_success: 'Налаштування експортуються успішно',
        export_hint:
            'Зверніть увагу, що можна експортувати тільки раніше збережені налаштування модулів, що активно активуються.',
        import_success:
            'Налаштування успішно імпортовано. Вам потрібно перезавантажити сторінку, щоб змусити їх працювати.',
        import_missmatch:
            'Файл зчитування, на жаль, більше не сумісний з поточною версією LSSM.',
        import_fail:
            'Помилка. Під час імпорту файлу сталася помилка: <strong> {0} </strong>. Повідомте про це розробника.',
    };
    ...
    I18n.translations.ja_JP.lssm.managedsettings = {
        ...
        reset_btn: '設定をリセット',
        reset_hint:
            'このモジュールの設定をデフォルト値にリセットしてもよろしいですか？',
        reset_success:
            '設定を正常にリセットしました。 それらを機能させるには、ページをリロードする必要があります。',
        export_success: '正常にエクスポートされた設定',
        export_hint:
            '現在アクティブ化されているモジュールの以前に保存された設定のみをエクスポートできることに注意してください。',
        import_success:
            '設定は正常にインポートされました。 それらを機能させるには、ページをリロードする必要があります。',
        import_missmatch:
            '残念ながら、読み込みファイルは現在のバージョンのLSSMと互換性がありません。',
        import_fail:
            'エラー：ファイルのインポート中にエラーが発生しました： <strong> {0} </strong>. 開発者に連絡してください。',
    };
    ...
    I18n.translations.ko_KR.lssm.managedsettings = {
        ...
        reset_success:
            '설정을 성공적으로 재설정했습니다. 작동하려면 페이지를 새로 고침해야합니다.',
        export_success: '성공적으로 내 보낸 설정',
        export_hint:
            '현재 활성화 된 모듈의 이전에 저장된 설정 만 내보낼 수 있습니다.',
        import_success:
            '설정을 성공적으로 가져 왔습니다. 작동하려면 페이지를 새로 고침해야합니다.',
        import_missmatch:
            '불행히도 읽기 파일은 더 이상 현재 LSSM 버전과 호환되지 않습니다.',
        import_fail:
            '오류 : 파일을 가져 오는 중 오류가 발생했습니다 : <strong> {0} </strong>. 개발자에게 알려주십시오.',
    };
    ...
    I18n.translations.ro_RO.lssm.managedsettings = {
        ...
        reset_hint:
            'Sigur reinițializați setările acestui modul la valorile implicite?',
        reset_success:
            'Reinițializați cu succes setările. Trebuie să reîncărcați pagina pentru a le face să funcționeze.',
        export_success: 'Setări exportate cu succes',
        export_hint:
            'Rețineți că numai setările salvate anterior ale modulelor activate în prezent pot fi exportate.',
        import_success:
            'Setările au fost importate cu succes. Trebuie să reîncărcați pagina pentru a le face să funcționeze.',
        import_missmatch:
            'Fișierul de citire nu mai este, din păcate, compatibil cu versiunea curentă de LSSM.',
        import_fail:
            'Eroare: Eroare la importul fișierului: <strong> {0} </strong>. Vă rugăm să informați un dezvoltator.',
    };
    ...
    I18n.translations.fi_FI.lssm.managedsettings = {
        ...
        reset_hint:
            'Haluatko varmasti palauttaa tämän moduulin asetukset oletusarvoihin?',
        reset_success:
            'Palauta asetukset onnistuneesti. Sivu on ladattava uudelleen, jotta ne toimivat.',
        export_success: 'Asetusten vienti onnistui',
        export_hint:
            'Huomaa, että vain aktiivisesti aktivoitujen moduulien aiemmin tallennetut asetukset voidaan viedä.',
        import_success:
            'Asetusten tuonti onnistui. Sivu on ladattava uudelleen, jotta ne toimivat.',
        import_missmatch:
            'Lukutiedosto ei valitettavasti ole enää yhteensopiva LSSM: n nykyisen version kanssa.',
        import_fail:
            'Virhe: Tiedoston tuonnissa tapahtui virhe: <strong> {0} </strong>. Ole hyvä ja ilmoita siitä kehittäjälle.',
    };

    I18n.translations.nl_NL.lssm.managedsettings = {
        title: 'LSSM instellingen',
        text1:
            'Hier kun je de instellingen van je geïnstalleerde plugins aanpassen.',
        text2: '',
        ...
        export_hint:
            'Houdt er rekening mee dat alleen eerder opgeslagen instellingen van momenteel geactiveerde modules kunnen worden geëxporteerd.',
        import_success:
            'De instellingen zijn succesvol geïmporteerd. Ververs de pagina om ze te gebruiken.',
        import_missmatch:
