(function ($, I18n) {
    ...
    I18n.translations.de_DE.lssm['n-alarm'] = {
        not_support:
            'Dieser Browser unterstützt leider keine HTML5-Notifications',
        ...
        settings: {
            ...
            chatp_text:
                'Alle Chatnachrichten auch als Popup-Nachrichten am rechten Rand anzeigen',
        },
    };
    ...
    I18n.translations.en_US.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            chatp_text:
                'Get all chat messages as popup message on the right side',
        },
    };
    ...
    I18n.translations.es_ES.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            status_title: 'Estado',
            status_text:
                'Obtenga todos los mensajes de estado como notificación.',
            chatp_title:
                'Obtener mensajes de chat como ventana emergente de información',
            chatp_text:
                'Obtener todos los mensajes de chat como mensaje emergente en el lado derecho',
        },
    };
    I18n.translations.pt_PT.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            status_title: 'Estado',
            status_text:
                'Obtenha todas as mensagens de estado como notificação.',
            chatp_title: 'Obtenha mensagens de chat como popup de informação',
            chatp_text:
                'Obtenha todas as mensagens de chat como mensagem popup no lado direito',
        },
    };
    ...
    I18n.translations.cs_CZ.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            chatp_title:
                'Získejte zprávy chatu jako informační vyskakovací okno',
            chatp_text:
                'Získejte všechny chatové zprávy jako vyskakovací zprávu na pravé straně',
        },
    };
    ...
    I18n.translations.pl_PL.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            status_title: 'Status',
            status_text:
                'Uzyskaj wszystkie komunikaty o statusie jako powiadomienie.',
            chatp_title:
                'Pobierz wiadomości na czacie jako okienko informacyjne',
            chatp_text:
                'Pobierz wszystkie wiadomości czatu jako wiadomość wyskakującą po prawej stronie',
        },
    };
    ...
    I18n.translations.sv_SE.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            chatp_text:
                'Få alla chattmeddelanden som popup-meddelande på höger sida',
        },
    };
    ...
    I18n.translations.it_IT.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            chatp_text:
                'Ricevi tutti i messaggi di chat come messaggio popup sul lato destro',
        },
    };
    ...
    I18n.translations.fr_FR.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            chatp_title:
                "Obtenir des messages de chat sous forme de popup d'information",
            chatp_text:
                'Obtenir tous les messages du chat sous forme de message popup sur le côté droit',
        },
    };
    ...
    I18n.translations.ro_RO.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            chatp_text:
                'Obținetoate mesajele de chat ca mesaj pop-up în partea dreaptă',
        },
    };
    ...
    I18n.translations.nl_NL.lssm['n-alarm'] = {
        ...
        settings: {
            ...
            chatp_text:
                'Alle chatberichten ook als Popup-berichten aan de rechter rand van het scherm tonen',
        },
    };
        ...
        if (!('Notification' in window)) {
            ...
            if (type === 'Chat') {
                notification = new Notification(
                    I18n.t('lssm.n-alarm.chat_message') + username,
                    {
                        body: message,
                        icon: lssm.getlink(
                            '/modules/lss-notification_alert/img/134895.png'
                        ),
                    }
                );
                setTimeout(function () {
                ...
                notification = new Notification(username, {
                    body: message,
                    icon: lssm.getlink(
                        '/modules/lss-notification_alert/img/Status_' +
                            fms +
                            '.png'
                    ),
                });
                ...
                notification.onclick = function () {
                    $('body').append(
                        '<a href="/vehicles/' +
                            ...
                            '_' +
                            fms +
                            '" class="btn btn-xs btn-default lightbox-open">' +
                            username +
                            '</a>'
                    );
                    $('#v_' + vid + '_' + fms + '').click();
    ...
    let $contentDiv = $(
        '<div class="panel-body" style="background-color: white; color: black;"></div>'
    );
    ...
    function ChatPopup(date, user_id, username, mission_id, message) {
        let e =
            ...
            "] <a href='/profile/" +
            user_id +
            "' class='lightbox-open' style='color: blue;'>" +
            username +
            ':</a></span>';
        mission_id &&
            (e =
        ...
        $(e)
            .appendTo($ul)
            .delay(getSetting('n-alarm-timeout-chatp') * 1000)
            .hide('slow', function () {
                $(this).remove();
            });
        $mainDiv.show('slow');
    ...
    $(document).bind(lssm.hook.postname('allianceChat'), function (event, t) {
        if (
            user_id !== t.user_id &&
            getSetting('n-alarm-chat') &&
            !getSetting('n-alarm-chatp')
        ) {
