(function () {
    ...
    I18n.translations.de_DE.lssm.statusDispatching = {
        ...
        settingsAttr:
            '"Sprechwunsch bearbeiten" in Einsatzmaske automatisch anklicken',
        settingsAttrDesc:
            'Die Aktivierung dieser Option bewirkt, dass bei einem Einsatz mit einem offenen Status 5 zuerst der Status bearbeitet werden muss, bevor der Einsatz weiter bearbeitet werden kann. Wird diese Option also aktiviert, werden alle Status 5 schneller bearbeitet.<br>' +
    ...
    I18n.translations.en_US.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Click the button "Transport Requested" in mission mask automatically',
        settingsAttrDesc:
            'Enabling this option provides automatic clicking on the "transport requested" button in the mission mask. This way you have to go through all transport requests before you can view details to the mission. Enabling this option allows faster processing of the transport requests.<br>' +
    ...
    I18n.translations.es_ES.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Haga clic en el botón "Transport Requested" en la máscara de la misión automáticamente.',
        settingsAttrDesc:
            'La activación de esta opción permite hacer clic automáticamente en el botón "transport requested" de la máscara de la misión. De esta forma, tendrá que pasar por todas las solicitudes de transporte antes de poder ver los detalles de la misión. Habilitar esta opción permite un procesamiento más rápido de las órdenes de transporte.<br>' +
    ...
    I18n.translations.pl_PL.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Kliknij przycisk "Transport Requested" w masce misji automatycznie.',
        settingsAttrDesc:
            'Włączenie tej opcji umożliwia automatyczne kliknięcie przycisku "żądany transport" w masce misji. W ten sposób musisz przejść przez wszystkie żądania transportowe, zanim będziesz mógł zobaczyć szczegóły misji. Włączenie tej opcji pozwala na szybsze przetwarzanie żądań transportowych.<br>' +
    ...
    I18n.translations.sv_SE.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Klicka automatiskt på knappen "Transport begärt" i uppdragsmask',
        settingsAttrDesc:
            'Aktivering av detta alternativ ger automatisk klickning på knappen "begärd transport" i uppdragsmask. På det här sättet måste du gå igenom alla transportförfrågningar innan du kan se detaljer till uppdraget. Att aktivera detta alternativ möjliggör snabbare behandling av transportförfrågningar.<br>' +
    ...
    I18n.translations.cs_CZ.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Automaticky klikněte na tlačítko „Požadován transport“ v masce mise',
        settingsAttrDesc:
            'Povolením této možnosti získáte automatické klepnutí na tlačítko „Požadovaný transport“ v masce mise. Tímto způsobem musíte projít všechny požadavky na dopravu, než budete moci zobrazit podrobnosti mise. Povolení této možnosti umožní rychlejší zpracování požadavků na přepravu.<br>' +
    ...
    I18n.translations.da_DK.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Klik automatisk på knappen "Anmodet om transport" i missionmasken',
        settingsAttrDesc:
            'Aktivering af denne mulighed giver automatisk klik på knappen "anmodet om transport" i missionsmasken. På denne måde skal du gennemgå alle transportanmodninger, før du kan se detaljer til missionen. Aktivering af denne mulighed giver hurtigere behandling af transportanmodninger.<br>' +
    ...
    I18n.translations.nb_NO.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Klikk automatisk på knappen "Forespurt transport" i oppdragsmaske',
        settingsAttrDesc:
            'Aktivering av dette alternativet gir automatisk klikk på "transport bedt om" -knappen i oppdragsmasken. På denne måten må du gå gjennom alle transportforespørsler før du kan se detaljer til oppdraget. Aktivering av dette alternativet gir raskere behandling av transportforespørsler. <br> ' +
    ...
    I18n.translations.it_IT.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Fare clic sul pulsante "Trasporto richiesto" nella maschera di missione automaticamente',
        settingsAttrDesc:
            "L'attivazione di questa opzione permette di cliccare automaticamente sul pulsante \"trasporto richiesto\" nella maschera di missione.In questo modo è necessario esaminare tutte le richieste di trasporto prima di poter visualizzare i dettagli della missione.L'attivazione di questa opzione consente un'elaborazione più rapida delle richieste di trasporto.<br>" +
    ...
    I18n.translations.fr_FR.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Cliquez sur le bouton "Transport Demandé" dans le masque de mission automatiquement',
        settingsAttrDesc:
            'L\'activation de cette option permet de cliquer automatiquement sur le bouton "transport demandé" dans le masque de mission. De cette façon, vous devez passer en revue toutes les demandes de transport avant de pouvoir voir les détails de la mission.L\'activation de cette option permet un traitement plus rapide des demandes de transport.<br>' +
    ...
    I18n.translations.ko_KR.lssm.statusDispatching = {
        ...
        settingsAttrDesc:
            '이 옵션을 활성화하면 미션 마스크에서 "전송 요청"버튼을 자동으로 클릭 할 수 있습니다. 이렇게하면 임무에 대한 세부 정보를보기 전에 모든 전송 요청을 수행해야합니다. 이 옵션을 사용하면 전송 요청을보다 빠르게 처리 할 수 있습니다.<br>' +
    ...
    I18n.translations.ro_RO.lssm.statusDispatching = {
        ...
        settingsAttr:
            'Faceți clic pe butonul "Transport solicitat" în masca de misiune automat',
        settingsAttrDesc:
            'Activarea acestei opțiuni oferă clic automat pe butonul " transport solicitat " din masca de misiune. În acest fel va trebui să treacă prin toate cererile de transport înainte de a putea vizualiza detalii la misiune. Activarea acestei opțiuni permite procesarea mai rapidă a solicitărilor de transport.<br>' +
    ...
    I18n.translations.nl_NL.lssm.statusDispatching = {
        ...
        settingsAttr:
            'De knop "Spraakaanvraag beantwoorden" in het meldingsvenster automatisch indrukken.', // TODO:
        // NL
        settingsAttrDesc:
            'Door deze optie in te schakelen wordt de knop "spraakaanvraag beantwoorden" in het meldingsvenster automatisch ingedrukt. Op deze manier verwerk je sneller achter elkaar alle spraakaanvragen in plaats van dat je eerst nog de details van de desbetreffende melding te zien krijgt.<br>' +
        ...
        settings: {
            fastS5: {
                ...
                ui: {
                    ...
                    description: I18n.t(
                        'lssm.statusDispatching.settingsAttrDesc'
                    ),
                    type: 'checkbox',
                },
            },
    ...
    function statusDispatching() {
        ...
        if (getSetting('fastS5')) {
            ...
            if (fms.length > 0) {
                if (
                    fms[0].innerText.match(I18n.t('lssm.statusDispatching.fms'))
                )
                    fms[0].click();
            }
        }
        ...
        for (let i = 0; i < nextVehicle.length; i++) {
            if (
                nextVehicle.length > 0 &&
                nextVehicle[i].innerText.match(
                    I18n.t('lssm.statusDispatching.nextVehicle')
                )
            ) {
                nextVehicle[i].click();
                next_clicked = true;
        ...
        for (let i = 0; i < label.length; i++) {
            if (
                label[i].innerText.match(
                    I18n.t('lssm.statusDispatching.fms5H1')
                )
            ) {
                allTransported = true;
            }
