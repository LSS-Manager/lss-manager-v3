(($, win, I18n) => {
    ...
    function updateValues() {
        ...
        if (allianceFundsCredits) {
            ...
            if (typeof $('#allianceFundsChart')[0] !== "undefined") {
    ...
    $('li:not(.chart)[chart]').hover(function() {
        $('li.chart[chart="' + $(this).attr('chart') + '"]').toggle();
    });
