(($, win, I18n) => {
    ...
    I18n.translations.de_DE.lssm.verbandsverwaltung = {
        ...
        page: 'Seite',
        updateMessage:
            'Werte aktualisieren sich<br>automatisch alle ' +
            updateMin +
            ' Minuten.',
        chartErr:
            'Konnte Grafik "{{chart}}" nicht laden!<br>Wir wissen bereits, dass dies bei manchen Browsern vorkommt, allerdings noch nicht warum. Bitte mache diesbezüglich <b>keine</b> Fehlermeldung, wir sind bereits an diesem Problem dran!',
        hoverTip:
            'Tipp: Fahre mit der Maus über ein Element, um einen Werte-Verlauf angezeigt zu bekommen.',
    };
    I18n.translations.en_US.lssm.verbandsverwaltung = {
        ...
        page: 'Page',
        updateMessage:
            'Values update automatically<br>every ' + updateMin + ' minutes.',
        chartErr:
            'Could not load chart "{{chart}}"!<br>We already know that this happens with some browsers, but not yet why. Please <b>don\'t</b> report us this error as we are already on this problem!',
    ...
    I18n.translations.es_ES.lssm.verbandsverwaltung = {
        ...
        page: 'Página',
        updateMessage:
            'Los valores se actualizan automáticamente<br>cada ' +
            updateMin +
            ' actas.',
        chartErr:
            'No se pudo cargar el gráfico "{{chart}}"!<br>Ya sabemos que esto sucede con algunos navegadores, pero aún no sabemos por qué. Por favor <b>no nos informe de este error ya que estamos en este problema!',
        hoverTip:
            'Consejo: Pase el ratón por encima de un elemento para mostrar un historial de valores.',
    };
    I18n.translations.pt_PT.lssm.verbandsverwaltung = {
        ...
        page: 'Página',
        updateMessage:
            'Os valores são atualizados automaticamente<br>cada ' +
            updateMin +
            ' minutos.',
        chartErr:
            'Não foi possível carregar o gráfico "{{chart}}"!<br>Já sabemos que isso acontece com alguns navegadores, mas ainda não o porquê. Por favor <b>não</b> relate-nos este erro, pois já estamos nesse problema!',
        hoverTip:
            'Dica: Passe o mouse sobre um elemento para exibir um histórico de valores.',
    };
    I18n.translations.cs_CZ.lssm.verbandsverwaltung = {
        ...
        page: 'Stránka',
        updateMessage:
            'Hodnoty se aktualizují automaticky <br> každý' +
            updateMin +
            ' minut.',
        chartErr:
            'Graf nelze načíst "{{chart}}"!<br>Už víme, že k tomu dochází u některých prohlížečů, ale zatím proč. Prosím, <b> neoznámte nám tuto chybu, protože jsme již na tento problém!',
    ...
    I18n.translations.pl_PL.lssm.verbandsverwaltung = {
        ...
        page: 'Strona',
        updateMessage:
            'Automatyczna aktualizacja wartości<br>każdy ' +
            updateMin +
            ' minuty.',
        chartErr:
            'Nie można było wprowadzić wykresu obciążenia. "{{chart}}"!<br>Wiemy już, że dzieje się to w przypadku niektórych przeglądarek, ale jeszcze nie wiemy dlaczego. Proszę <b>don\'t</b> zgłoś nam ten błąd, ponieważ jesteśmy już na tym problemie!',
        hoverTip:
            'Wskazówka: Przejechać nad elementem, aby wyświetlić historię wartości.',
    };
    I18n.translations.sv_SE.lssm.verbandsverwaltung = {
        ...
        page: 'Sida',
        updateMessage:
            'Värden uppdateras automatiskt <br> varje ' +
            updateMin +
            ' minuter.',
        chartErr:
            'Det gick inte att ladda diagrammet "{{chart}}"!<br>Vi vet redan att detta händer med vissa webbläsare, men ännu inte varför. Snälla <b> inte </b> anmäla oss det här felet eftersom vi redan har problemet!',
        hoverTip:
            'Tips: Håll muspekaren över ett element för att visa en värdehistorik.',
    };
    I18n.translations.da_DK.lssm.verbandsverwaltung = {
        ...
        page: 'Side',
        updateMessage:
            'Værdier opdateres automatisk<br>hvert ' + updateMin + ' minut.',
        chartErr:
            'Kunne ikke indlæse diagram "{{chart}}"!<br>Vi ved allerede, at dette sker med nogle browsere, men endnu ikke hvorfor. Venligst <b> ikke </b> indberet os denne fejl, da vi allerede har problemet.',
        hoverTip:
            'Tip: Hold markøren over et element for at få vist en værdihistorik.',
    };
    I18n.translations.nb_NO.lssm.verbandsverwaltung = {
        ...
        page: 'Side',
        updateMessage:
            'Verdiene oppdateres automatisk <br> hver ' +
            updateMin +
            ' minutter.',
        chartErr:
            'Kunne ikke laste diagrammet "{{chart}}"!<br>Vi vet allerede at dette skjer med noen nettlesere, men ennå ikke hvorfor. Vennligst <b> ikke </b> rapporter oss denne feilen, da vi allerede har dette problemet!',
        hoverTip:
            'Tips: Hold musepekeren over et element for å vise en verdihistorikk.',
    };
    I18n.translations.it_IT.lssm.verbandsverwaltung = {
        ...
        page: 'Page',
        updateMessage:
            'Aggiornamento automatico dei valori<br>ogni volta ' +
            updateMin +
            ' minuti.',
        chartErr:
            'Impossibile caricare il grafico "{{chart}}"!<br>Sappiamo già che questo accade con alcuni browser, ma non ancora perché. Per favore <b>don\'t</b> segnalateci questo errore perché siamo già su questo problema!',
        hoverTip:
            'Suggerimento: passare con il mouse su un elemento per visualizzare la cronologia dei valori.',
    };
    I18n.translations.fr_FR.lssm.verbandsverwaltung = {
        ...
        page: 'Page',
        updateMessage:
            'Mise à jour automatique des valeurs <br>chaque valeur ' +
            updateMin +
            ' minutes.',
        chartErr:
            'Impossible de charger le graphique "{{chart}}"!<br>Nous savons déjà que cela se produit avec certains navigateurs, mais pas encore pourquoi. S\'il vous plaît<b>don\'t</b> nous signaler cette erreur comme nous sommes déjà sur ce problème !',
        hoverTip:
            "Astuce : Survolez un élément pour afficher l'historique des valeurs.",
    };
    I18n.translations.ko_KR.lssm.verbandsverwaltung = {
        ...
        page: '페이지',
        updateMessage:
            '값이 자동으로 업데이트됩니다<br>마다 ' + updateMin + ' 의사록.',
        chartErr:
            '차트를로드 할 수 없습니다 "{{chart}}"!<br>우리는 이것이 이미 일부 브라우저에서 발생한다는 것을 알고 있지만 아직 이유는 없습니다. 부디 <b>하지마</b> 이미이 문제에 대해이 오류를보고하십시오!',
    ...
    I18n.translations.ro_RO.lssm.verbandsverwaltung = {
        ...
        page: 'Pagina',
        updateMessage:
            'Actualizarea automată a valorilor<br>Fiecare ' +
            updateMin +
            ' Minute.',
        chartErr:
            'Imposibil de încărcat diagrama "{{chart}}"!<br>Știm deja că acest lucru se întâmplă cu unele browsere, dar nu încă de ce. Vă rugăm să nu \'t raport- ne această eroare ca suntem deja pe această problemă!',
        hoverTip:
            'Indicație: treceți cu mouse-ul peste un element pentru a afișa un istoric de valori.',
    };
    I18n.translations.nl_NL.lssm.verbandsverwaltung = {
        ...
        page: 'Pagina',
        updateMessage:
            'Waarden worden elke<br>' +
            updateMin +
            ' minuten automatisch bijgewerkt.',
        chartErr:
            'Kon de grafiek "{{chart}" niet laden!<br>We weten al dat dit bij sommige browsers gebeurt, maar nog niet waarom. Meld ons deze fout alstublieft <b>niet</b>, want we zijn al bezig met dit probleem!',
        hoverTip:
            'Tip: Beweeg de muis over een element om een waardegeschiedenis weer te geven.',
    };
    async function loadChart(element, name, data) {
        try {
            ...
            element.html(
                I18n.t('lssm.verbandsverwaltung.chartErr').replace(
                    /{{chart}}/,
                    name
                )
            );
    ...
    function drawGUI(storage, lastKey) {
        ...
        if (lastArr.finance_active) {
            $('#verbandsverwaltungAllianceFunds').html(
                '<a href="/verband/kasse" class="lightbox-open">' +
                    ...
                    ': ' +
                    '' +
                    lastArr.credits.toLocaleString() +
                    ' Credits' +
                    '</a>'
            );
        }
        ...
        $('#verbandsverwaltungAllianceCredits').html(
            I18n.t('lssm.verbandsverwaltung.allianceCredits') +
                ': ' +
                lastArr.total.toLocaleString() +
                ' Credits'
        );

        // And display the latest values
        $('#verbandsverwaltungAllianceRank').html(
            '<a href="/alliances?page=' +
                lastArr.page +
                '" class="lightbox-open">' +
                '' +
                ...
                ' (' +
                '' +
                I18n.t('lssm.verbandsverwaltung.page') +
                ' ' +
                lastArr.page.toLocaleString() +
                ')' +
                '</a>'
        );
        ...
        $('#verbandsverwaltungUsers').html(
            '<a href="/verband/mitglieder" class="lightbox-open">' +
                ...
                ': ' +
                '' +
                lastArr.online.toLocaleString() +
                '/' +
                lastArr.users.toLocaleString() +
                ' ' +
                '(' +
        ...
        loadChart(
            $('#allianceRankPageChart'),
            I18n.t('lssm.verbandsverwaltung.page'),
            allianceRankPageData
        );
        loadChart(
            $('#allianceUserChart'),
            I18n.t('lssm.verbandsverwaltung.users'),
            userData
        );
        loadChart(
            $('#allianceUserOnlineChart'),
            I18n.t('lssm.verbandsverwaltung.onlineUsers'),
            userOnlineData
        );
    }
        ...
        for (let key in storage) {
            if (storage.hasOwnProperty(key)) {
                ...
                if (keyTime <= time - 86400) {
                    ...
                    lastEntry =
                        keyTime > (lastEntry || 0) ? keyTime : lastEntry;
                }
            }
        }
            ...
            $.ajax({
                ...
                success(response) {
                    ...
                    storage[time] = {
                        ...
                        rank: response.rank,
                        page:
                            parseInt(response.rank / 20) +
                            (response.rank % 20 ? 1 : 0),
    ...
    let markup =
        '<li role="presentation"  id="verbandsverwaltung" class="alliance_true"><a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><b class="caret" style="transform: rotate(90deg);"></b>&nbsp;' +
        I18n.t('lssm.verbandsverwaltung.name') +
        '</a><ul id="verbandsverwaltungDropdown"><li role="presentation" id="verbandsverwaltungUsers" chart="user"><a href="/verband/mitglieder" class="lightbox-open" chart="user">Mitglieder online: 0</a></li><li role="presentation" id="verbandsverwaltungAllianceFunds" chart="funds"><a href="/verband/kasse" class="lightbox-open">Verbandskasse: 0 Credits</a></li><li role="presentation" id="verbandsverwaltungAllianceCredits" chart="credits">Verdiente Credits: 0 Credits</li><li role="presentation" id="verbandsverwaltungAllianceRank" chart="rank">Platz in der Verbandsliste: 0</li><li class="divider" role="presentation"></li><li role="presentation">' +
        I18n.t('lssm.verbandsverwaltung.updateMessage') +
        '</li><li class="divider" role="presentation"></li><li role="presentation">' +
        I18n.t('lssm.verbandsverwaltung.hoverTip') +
        '</li></ul><ul id="verbandsverwaltungCharts"><li><span id="allianceCreditsChart" class="chart" chart="credits"></span></li><li><span id="allianceFundsChart" class="chart" chart="funds"></span></li><li><span id="allianceRankChart" class="chart" chart="rank"></span><span id="allianceRankPageChart" class="chart" chart="rank"></span></li><li><span id="allianceUserChart" class="chart" chart="user"></span><span id="allianceUserOnlineChart" class="chart" chart="user"></span></li></ul></li>';
