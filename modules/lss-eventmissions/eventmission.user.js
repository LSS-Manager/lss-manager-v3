(function (I18n, $) {
	...
	function replaceevMissionCaption(text) {
		if (text !== undefined && text !== "") {
			...
			text = text.replace('Behandlung nach Schwalbe', '[WM] Behandlung nach Schwalbe');
			text = text.replace('Prellung nach Lattenpraller', '[WM] Prellung nach Lattenpraller');
			text = text.replace('Tor gefallen', '[WM] Tor gefallen');
			text = text.replace('Pokal geklaut', '[WM] Pokal geklaut');
			//Sommer Missions
			...
			text = text.replace('Robo en el mercado navideño', '[X-MAS] Robo en el mercado navideño');
			text = text.replace('Puesto del mercado de Navidad en llamasl', '[X-MAS] Puesto del mercado de Navidad en llamas');
			text = text.replace('Incendio en el mercado navideño', '[X-MAS] Incendio en el mercado navideño');
			text = text.replace('Accidente de tráfico debido a hielo', '[X-MAS] Accidente de tráfico debido a hielo');
			text = text.replace('Árbol de navidad en llamas', '[X-MAS] Árbol de navidad en llamas');
			text = text.replace('Corona de Adviento en llamas', '[X-MAS] Corona de Adviento en llamas');
			text = text.replace('Pelea en mercado navideño', '[X-MAS] Pelea en mercado navideño');

			text = text.replace('Kradzież na jarmarku bożonarodzeniowym', '[X-MAS] Kradzież na jarmarku bożonarodzeniowym');
			text = text.replace('Płonący stragan bożonarodzeniowy', '[X-MAS] Płonący stragan bożonarodzeniowy');
			text = text.replace('Pożar na jarmarku bożonarodzeniowym', '[X-MAS] Pożar na jarmarku bożonarodzeniowym');
			text = text.replace('Wypadek drogowy - lód', '[X-MAS] Wypadek drogowy - lód');
			text = text.replace('Płonąca choinka', '[X-MAS] Płonąca choinka');
			text = text.replace('Płonący wieniec adwentowy', '[X-MAS] Płonący wieniec adwentowy');
			text = text.replace('Bójka na jarmarku bożonarodzeniowym', '[X-MAS] Brawl at christmas market');

			text = text.replace('Stöld på julmarknad', '[X-MAS] Stöld på julmarknad');
			text = text.replace('Brinnande julstånd', '[X-MAS] Burning christmas market stall');
			text = text.replace('Brand på julmarknad', '[X-MAS] Brand på julmarknad');
			text = text.replace('Trafikolycka - is', '[X-MAS] Trafikolycka - is');
			text = text.replace('Brinnande julgran', '[X-MAS] Brinnande julgran');
			text = text.replace('Brinnande julkrans', '[X-MAS] Brinnande julkrans');
			text = text.replace('Bråk på julmarknad', '[X-MAS] Bråk på julmarknad');
