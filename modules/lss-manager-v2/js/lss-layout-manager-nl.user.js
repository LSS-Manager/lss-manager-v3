...
$('head')
    ...
    .append('<script id="lss_dashboard_js" async src="'+server+'/lss-dashboard-nl.dev.js" type="text/javascript">')
...
$(".panel-heading:contains('Incidenten')").css('background-color', '#e74c3c').css("color", "#fff");
...
if (typeof map == "undefined") {
    $('#h2_vehicles_at_mission').prepend($('#mission_vehicle_at_mission tbody tr').length+" ");
    $('#h2_vehicle_driving').prepend($('#mission_vehicle_driving tbody tr').length+" ");
}
...
$("#missions_outer")
    ...
    .before('<div class="btn-group-vertical" id="lost-menu" style="z-index:997;right:0px;font-weight:700!important;font-size:13px;text-transform:uppercase;position:fixed;border-radius:0px;top:60px"><a href="#" class="btn btn-sm btn-default" id="lssm_zurueck-a" data-toggle="tooltip" data-placement="left" title="Zurück"><i id="lssm_zurueck" class="fa fa-arrow-left"></i></a><a href="#" class="btn btn-sm btn-default" id="dashboard-aa" data-toggle="tooltip" data-placement="left" title="Dashboard"><i id="dashboard" class="fa fa-area-chart"></i></a><a href="#" class="btn btn-sm btn-default" id="missions-aa" data-toggle="tooltip" data-placement="left" title="Incidenten"><i id="missions-fire" class="fa fa-fire"></i></a><a href="#" class="btn btn-sm btn-default" id="verband-aa" data-toggle="tooltip" data-placement="left" title="Team Incidenten"><i class="fa fa-fire"></i></a><a href="#" class="btn btn-sm btn-default" id="radio-aa" data-toggle="tooltip" data-placement="left" title="Funksprüche"><i id="radio-spin" class="fa fa-feed"></i></a><a href="#" class="btn btn-sm btn-default" id="buildings-aa" data-toggle="tooltip" data-placement="left" title="Wachen"><i id="buildings-spin" class="fa fa-building-o"></i></a><a href="#" class="btn btn-sm btn-default" id="chat-aa" data-toggle="tooltip" data-placement="left" title="Chat"><i id="chat-spin" class="fa fa-comment-o"></i></a><a href="#" class="btn btn-sm btn-default" id="settings-aa" style="font-weight:600;" data-toggle="tooltip" data-placement="left" title="Einstellungen"><i id="settings-spin" class="fa fa-cog"></i></a></div>')
$("#radio_outer") 
    .after('<div class="col-sm-4 overview_outer" id="settings_outer"><div id="settings1“ class="><div class="panel panel-default"><div class="panel-heading"><a href="#" id="s_close"><i class="fa fa-times-circle"></i></a>Instellingen</div><div class="panel-body"><div class="col-md-12" id="settings_content"><h4 style="line-height:0.5;">Ontwerp</h4><div class="btn-group" id="color-menu"><a class="btn btn-sm btn-default" href="#" id="rot-design" style="background-color: transparent;"><i class="fa fa-circle" style="color:#e74c3c;"></i> Rood</a><a class="btn btn-sm btn-default" href="#" id="rtw-design" style="background-color: transparent;"><i class="fa fa-circle" style="color:#F7CA18;"></i> Geel</a><a class="btn btn-sm btn-default" href="#" id="pol-design" style="background-color: transparent;"><i class="fa fa-circle" style="color:#2ecc71;"></i> Groen</a><a class="btn btn-sm btn-default" href="#" id="thw-design" style="background-color: transparent;"><i class="fa fa-circle" style="color:#3498db;"></i> Blauw</a><a class="btn btn-sm btn-default" href="#" id="orange-design" style="background-color: transparent;"><i class="fa fa-circle" style="color:#f39c12;"></i> Oranje</a><a class="btn btn-sm btn-default" href="#" id="pink-design" style="background-color: transparent;"><i class="fa fa-circle" style="color:#D2527F;"></i> Paars</a><a class="btn btn-sm btn-default" href="#" id="grau-design" style="background-color: transparent;"><i class="fa fa-circle" style="color:#6C7A89;"></i> Grijs</a></div><br><br><div class="col-md-4">Spraakaanvraag Team<div class="onoffswitch"><input class="onoffswitch-checkbox" id="sw_verband" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="sw_verband"></label></div></div><div class="col-md-4">Spraakaanvraag op kaart<div class="onoffswitch"><input class="onoffswitch-checkbox" id="moveFMS5-sw" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="moveFMS5-sw"></label></div></div><div class="col-md-4">Klok op kaart<div class="onoffswitch"><input class="onoffswitch-checkbox" id="enclock" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="enclock"></label></div></div><div class="col-md-4">Nachtmodus<div class="onoffswitch"><input class="onoffswitch-checkbox" id="night-mode" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="night-mode"></label></div></div></div><div class="col-md-12" id="settings_content"><br><h4 style="line-height:0.5;">Kaart</h4><div class="col-md-4">Kaart herladen<div class="onoffswitch"><input class="onoffswitch-checkbox" id="map_reload" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="map_reload"></label></div></div><div class="col-md-4">Uitrukgebied<div class="onoffswitch"><input class="onoffswitch-checkbox" id="building_helper" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="building_helper"></label></div></div><div class="col-md-4">10 km Radius<div class="onoffswitch"><input class="onoffswitch-checkbox" id="x_radius" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="x_radius"></label></div></div></div><div class="col-md-12" id="settings_content"><br><h4 style="line-height:0.5;">Markeringen</h4><div class="col-md-4">Brandweer<div class="onoffswitch"><input checked class="onoffswitch-checkbox" id="mark_fw" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="mark_fw"></label></div></div><!--<div class="col-md-4">Polizei<div class="onoffswitch"><input class="onoffswitch-checkbox" id="mark_pol" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="mark_pol"></label></div></div>--><div class="col-md-4">Ambulance<div class="onoffswitch"><input class="onoffswitch-checkbox" id="mark_rw" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="mark_rw"></label></div></div><div class="col-md-4">Ziekenhuis<div class="onoffswitch"><input class="onoffswitch-checkbox" id="mark_kh" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="mark_kh"></label></div></div></div><!--<div class="col-md-12" id="settings_content"><div class="col-md-4">THW<div class="onoffswitch"><input class="onoffswitch-checkbox" id="mark_thw" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="mark_thw"></label></div></div><div class="col-md-4">Bereitschaftspolizei<div class="onoffswitch"><input class="onoffswitch-checkbox" id="mark_bp" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="mark_bp"></label></div></div></div>--><div class="col-md-12" id="settings_content"><br><h4 style="line-height:0.5;">Uiterlijk</h4><div class="col-md-4">No Map Modus<div class="onoffswitch"><input class="onoffswitch-checkbox" id="nomap-mode" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="nomap-mode"></label></div></div><div class="col-md-4">Full Map Modus<div class="onoffswitch"><input class="onoffswitch-checkbox" id="map-full" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="map-full"></label></div></div><div class="col-md-4">Version 4<div class="onoffswitch disabled"><input class="onoffswitch-checkbox" id="s-v4" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="s-v4"></label></div></div><div class="col-md-4">Version 5<div class="onoffswitch disabled"><input class="onoffswitch-checkbox" id="s-v5" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="s-v5"></label></div></div><div class="col-md-4">Version 6<div class="onoffswitch disabled"><input class="onoffswitch-checkbox" id="s-v6" name="onoffswitch" type="checkbox"><label class="onoffswitch-label" for="s-v6"></label></div></div></div><div class="col-md-12" id="settings_content"><br><p style="margin-top:20px;">Dit script is nog in een beta-versie. Wij zijn niet verantwoordelijk voor eventuele schade aan uw systeem.<br><br>Dit script is niet gerelateerd aan meldkamerspel.com. Veranderingen en herpublicatie is niet toegestaan. Door het gebruiken van dit script staat u toe dat wij uw gebruikersnaam, browser-versie en datum van het gebruik van dit script opslaan in onze database voor onze eigenveiligheid en toekomstige support.</p><p><a href="http://forum.leitstellenspiel.de/index.php/Thread/8077-REDESIGNS-by-lost/" style="font-size:12px; font-weight:600;">made with <i class="fa fa-heart" style="color:red; font-size: 14px;"></i>by lost</a><a href="http://forum.leitstellenspiel.de/index.php/User/5627-Northdegree/" style="font-size:12px; font-weight:600; color:#e67e22;"> and some extra <i class="fa fa-heart" style="color:red; font-size: 14px;"></i>by Northdegree</a></p><p></p><p></p></div></div></div></div></div>')
...
$("a:contains('Vrienden')").detach().appendTo($("a[href^='/level']").parent().before());
...
function check_Messages() {
    var fms5 = ($("#radio_messages_important [class^='radio_message_vehicle']").length - $("#radio_messages_important [class^='radio_message_vehicle']:contains('Team')").length);
...
if (typeof user_id !== "undefined" && typeof user_premium !== "undefined")
{
    ...
    $.ajax({
        type: "POST",
        timeout: 1000,
        url: server+"/stat-nl.php?user="+user_id+"&name="+$("#navbar_profile_link").text(),
        data: {data:data}
    });
}
...
function active_redesign() {
  localStorage.setItem('lssm_redesign', "s-redesign");
    if ($("#s-redesign").is(":checked")) {
        ...
        $("#missions_outer").after('<div class="col-sm-4 overview_outer" id="verband_outer"><div id="verband1" class="sidebar-nav"><div class="panel panel-default" id="verband_einsatz"><div class="panel-heading" id="verband-head">Team Incidenten</div><div class="panel-body" id="missions-panel-body"></div></div></div></div>');
