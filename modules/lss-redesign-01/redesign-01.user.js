(function($) {
    ...
    $('head').prepend(
        '<link href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.0.3/leaflet.css" type="text/css" rel="stylesheet"/>'
    );
  ...
  missionMarkerAdd = function (t) {
    ...
    $('body').prepend(
        ...
        '}' +
        '.money-block-web, .money-block {' +
        'display: none;' +
        '}' +
        '.mission-filters-block {' +
        'height: auto;' +
        'overflow-x: hidden;' +
        'overflow-y: scroll;' +
        'margin-bottom: auto;' +
        'padding: 0 200px 0 0' +
        '}' +
        '.mission-filters-block .mission-filters-row .mission-state-filters {' +
        'display: flex;' +
        'margin-right: 8px' +
        ' }' +

        '.mission-filters-block .mission-filters-row .mission-state-filters .mission_selection {' +
        'display: flex;' +
        'align-items: center' +
        '}' +

        '.mission-filters-block .mission-filters-row .mission-state-filters .mission_selection .icon svg {' +
        ' width: 100%;' +
        'height: 100%' +
        ' }' +

        '.mission-filters-block .mission-filters-row .mission-state-filters .mission_selection#mission_select_unattended .icon {' +
        ' fill: #d11919' +
        '}' +

        '.mission-filters-block .mission-filters-row .mission-state-filters .mission_selection#mission_select_attended .icon {' +
        ' fill: #e8f82b' +
        '}' +

        '.mission-filters-block .mission-filters-row .mission-state-filters .mission_selection#mission_select_finishing .icon {' +
        '  fill: #1bec19' +
        '  }' +

        '.mission-filters-block .mission-filters-row .mission-state-filters .mission_selection .icon {' +
        '  width: 13px;' +
        ' height: 13px;' +
        ' display: flex;' +
        'margin-right: 2px' +
        ...
        '.mission-filters-block .mission-filters-row .mission-state-filters .mission_selection .icon path {' +
        ' stroke: #fff' +
        '  }' +

        '.mission-filters-block .mission-filters-row .mission-participation-filters {' +
        ' display: flex' +
        '}' +
