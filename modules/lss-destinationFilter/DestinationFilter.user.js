(function(I18n, $) {
	...
	function setUi() {
		var markup = "<div>";
		markup += '<div><span class="pull-left"><div class="onoffswitch"><input class="onoffswitch-checkbox" id="lssm-inline-destfilter-beds" '
		...
		markup += '<div><span class="pull-left"><div class="onoffswitch"><input class="onoffswitch-checkbox" id="lssm-inline-destfilter-elegible" '
	...
	if (sprechwunsch.length > 0 && sprechwunsch.parent().text().indexOf(18n.t('lssm.destfilter.hospital')) >= 0) {
		setUi();
		filter();
	}
