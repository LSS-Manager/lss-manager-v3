(($, win, I18n) => {
    ...
    I18n.translations.de_DE.lssm.overview.buildings = {
        ...
        seg: {
            ...
            extensions:
                'Führung (3 Tage, 25.000 Credits/5 Coins)<br>Sanitätsdienst (3 Tage, 25.000 Credits/5 Coins)<br>Wasserrettung (7 Tage, 500.000 Credits/25 Coins)<br>Rettungshundestaffel (7 Tage, 350.000 Credits/25 Coins)',
            maxBuildings: 'Keine Grenze',
        },
        pol: {
            name: 'Polizeiwache',
            ...
            startVehicle: 'FuStW',
            extensions:
                'Zelle (25.000 Credits)<br>Max. 10 können gebaut werden<br>Diensthundestaffel (5 Tage, 100.000 Credits/10 Coins)',
            maxBuildings: '1.500',
            special:
        ...
        psonder: {
            ...
            startVehicle: 'Kein Startfahrzeug',
            extensions:
                'SEK 1. Zug (7 Tage, 100.000 Credits/10 Coins)<br>SEK 2. Zug(7 Tage, 100.000 Credits/10 Coins)<br>MEK 1. Zug (7 Tage, 100.000 Credits/10 Coins)<br>MEK 2. Zug (7 Tage, 100.000 Credits/10 Coins)<br>Diensthundestaffel (5 Tage, 100.000 Credits/10 Coins)',
            maxBuildings: 'Keine Grenze',
        },
        wr: {
            name: 'Wasserrettung',
        ...
        rhs: {
            ...
            maxBuildings: 'Keine Grenze',
            special:
                'Beim Bau bekommst du 10 Leute sowie ein Rettungshundefahrzeug geschenkt',
        },
        thw: {
    ...
    I18n.translations.de_DE.lssm.overview.vehicles = {
        ...
        pol: {
            ...
            pmoto: {
                ...
                special:
                    'Kann ein FuStW ersetzen, aber keine Gefangenen transportieren',
            },
        },
        bepol: {
            grukw: {
    ...
    I18n.translations.en_US.lssm.overview.buildings = {
        ...
        fw: {
            ...
            extensions:
                'Ambulance (7 Days, 100.000 Credits/20 Coins)<br>Water Rescue (7 Days, 100.000 Credits/20 Coins)<br>Airport (7 Days, 100.000 Credits/20 Coins)<br>Forestry (7 Days, 50.000 Credits/13 Coins)',
            maxBuildings: '2.400',
            special:
        ...
        fwklein: {
            ...
            maxlevel: 5,
            levelcost:
                '1. 10.000<br>2. 50.000<br>3.-5. 100.000<br>Conversion to Normal Guard: Difference Price to Normal Guard',
            startPersonell: 10,
            startVehicle: 'Type 1 fire engine, Type 2 fire engine',
            maxBuildings: '2.400',
            special:
                'From the 24th fire station onwards, the cost of building a new fire station increases according to the following formula: <code>50.000+200.000*LOG<sub>2</sub>(Number of existing fire stations − 22)</code>. Max. 1 Million Credits. The Coins price remains constant!',
        },
        fwschule: {
            name: 'Fire Academy',
            credits: 500000,
            ...
            startVehicle: 'No vehicles stationable',
            extensions:
                'Up to 3 more Classrooms (in each case 7 Days, 400.000 Credits/40 Coins)',
            maxBuildings: 'No limit',
            special:
                'Minister of Finance and Admins can be Allianz Fire Academys with the help of credits from the Allianz treasury (Expand) build.',
        },
        rw: {
        ...
        kh: {
            ...
            startPersonell: 0,
            startVehicle:
                'No vehicles can be stationed, but 10 beds from the start',
            extensions:
                'Several specialisations (in each case 7 Days, 70.000 Credits/15 Coins,  General Internal and General Surgeon only 10.000 Credits/10 Coins)',
            maxBuildings: 'No Limit',
            special:
                'Minister of Finance and Admins can be Allianz Hospital with the help of credits from the Allianz treasury (Expand) build.',
        },
        khklein: {
            name: 'Clinic',
            credits: 100000,
        ...
        rth: {
            ...
            extensions: 'No extensions possible',
            special:
                'Up to 4 landing sites can be built per station (expansion stages). Up to the 125th building (of all kinds) a maximum of 4 landing sites can be built. After that the number of all 25 buildings grows by 1 (starting with 125.).',
        },
        pol: {
            name: 'Police Station',
            credits: 100000,
        ...
        polschule: {
            ...
            maxBuildings: 'No limit',
            special:
                'Minister of Finance and Admins can be Allianz Police Academys with the help of credits from the Allianz treasury (Expand) build.',
        },
        polheli: {
    ...
    I18n.translations.en_US.lssm.overview.vehicles = {
        fd: {
            ...
            utun: {
                ...
                coins: 25,
                special:
                    'Required from 4 fire stations, can be used in place of a Heavy Rescue Vehicle. <br>Utility units can be used to tow Boat Trailers.',
            },
            boatt: {
                name: 'Boat Trailer',
                min: 0,
        ...
        rd: {
            ...
            flyc: {
                ...
                coins: 20,
                special:
                    'No missions require a Fly Car at this time, however it is able to treat patients.',
            },
            emsrescue: {
                name: 'EMS Rescue',
                min: 1,
    ...
    I18n.translations.en_GB.lssm.overview.buildings = {
        ...
        fw: {
            ...
            extensions:
                'Ambulance (7 Days, 100.000 Credits/20 Coins)<br>Water Rescue (7 Days, 100.000 Credits/20 Coins)<br>Airport (7 Days, 100.000 Credits/20 Coins)',
            maxBuildings: '2.400',
            special:
                'From the 24th fire station onwards, the cost of building a new fire station increases according to the following formula: <code>100.000+200.000*LOG<sub>2</sub>(Number of existing fire stations − 22)</code>. The Coins price remains constant!',
        },
        ...
        rth: {
            ...
            extensions: 'No extensions possible',
            special:
                'Up to 4 landing sites can be built per station (expansion stages). Up to the 125th building (of all kinds) a maximum of 4 landing sites can be built. After that the number of all 25 buildings grows by 1 (starting with 125.).You can also put Rapid Response Vehicle.',
        },
        kh: {
            name: 'Hospital',
            credits: 200000,
    ...
    I18n.translations.en_GB.lssm.overview.vehicles = {
        ...
        pol: {
            ...
            atrafc: {
                ...
                coins: 10,
                schooling:
                    'Roads Policing Officer Training and Firearms Training',
            },
        },
        heli: {
            hems: {
    ...
    I18n.translations.sv_SE.lssm.overview.buildings = {
        ...
        fw: {
            ...
            extensions:
                'Ambulans (7 Days, 100.000 Credits/20 Coins)<br>Vattenräddning (7 Days, 100.000 Credits/20 Coins)<br>Flygplats (7 Days, 100.000 Credits/20 Coins)',
            maxBuildings: '2.400',
            special:
                'Från den 24: e brandstationen och framåt ökar kostnaden för att bygga en ny brandstation enligt följande formel: <code>100.000+200.000*LOG<sub>2</sub>(Antal befintliga brandstationer − 22)</code>. Myntpriset förblir konstant!',
        },
        fwklein: {
            ...
            maxlevel: 5,
            levelcost:
                '1. 10.000<br>2. 50.000<br>3.-5. 100.000<br>Konvertering till Normal Guard: Skillnadspris till Normal Guard',
            startPersonell: 10,
            startVehicle: 'BAS 1 - Släckbil, BAS 2 - Släckbil',
            maxBuildings: '2.400',
            special:
                'Från den 24: e brandstationen och framåt ökar kostnaden för att bygga en ny brandstation enligt följande formel: <code>50.000+200.000*LOG<sub>2</sub>(Antal befintliga brandstationer − 22)</code>. Max. 1 miljon krediter. Myntpriset förblir konstant!',
        },
        fwschule: {
            name: 'Brandskola',
            credits: 500000,
            ...
            startVehicle: 'Inga fordon stationära',
            extensions:
                'Upp till 3 klassrum till (i båda fallen 7 dagar, 400 000 krediter / 40 mynt)',
            maxBuildings: 'Ingen gräns',
            special:
                'Finansminister och förvaltare kan vara Allianz Fire Academies med hjälp av krediter från Allianz Treasury (Expand).',
        },
        rw: {
        ...
        kh: {
            ...
            startPersonell: 0,
            startVehicle:
                'Inga fordon kan stationeras utan 10 bäddar från början',
            extensions:
                'Flera specialiseringar (i båda fallen 7 dagar, 70.000 krediter / 15 mynt,  General Internal and General Surgeon only 10.000 Credits/10 Coins)',
            maxBuildings: 'Ingen gräns',
            special:
                'Finansminister och administratörer kan vara Allianz Hospital med hjälp av krediter från Allianz Treasury (Expand).',
        },
        pol: {
            name: 'Polisstation',
            credits: 100000,
    ...
    I18n.translations.nl_NL.lssm.overview.buildings = {
        ...
        fw: {
            ...
            startPersonell: 10,
            startVehicle:
                'SI-2,TS 8/9,TST 8/9,TST 6/7,TST 4/5,TS 4/5,TST-NB 8/9,TST-NB 6/7,TST-NB 4/5,TS 6/7',
            extensions:
                'Ambulance (7 dagen, 100.000 Credits/20 Coins)<br>Waterongevallenbestrijding (7 dagen, 400.000 Credits/25 Coins)<br>Vliegtuigbrandbestrijding (7 dagen, 100.000 Credits/20 Coins)<br>10*Haakarmbak parkeerplaats (in alle gevallen 7 dagen, 100.000 Credits/20 Coins)',
            maxBuildings: '2.400',
            special:
                'Vanaf de 25e brandweerkazerne stijgen de kosten voor de bouw van een nieuwe brandweerkazerne volgens de volgende formule: <code>100.000+200.000*LOG<sub>2</sub>(Aantal brandweerposten − 22)</code>. De Coins prijs blijft constant!',
        },
        fwschule: {
            ...
            startVehicle: 'Geen voertuigen stationeerbaar',
            extensions:
                'Tot 3 extra klaslokalen (in alle gevallen 7 dagen, 400.000 Credits/40 Coins)',
        ...
        rwklein: {
            ...
            maxBuildings: 'Geen limiet',
            special:
                'Kan worden omgebouwd tot Ambulance standplaats voor 100.000 credits. Het ombouwen duurt 24 uur.',
        },
        rwschule: {
            ...
            maxBuildings: 'Geen limiet',
            special:
                'Penningmeesters en Admins kunnen de Team Universiteit Faculteit Geneeskunde met behulp van de credits van de Teamkas uitbreiden.',
        },
        kh: {
            name: 'Ziekenhuis',
            credits: 200000,
            ...
            startPersonell: 0,
            startVehicle:
                'Geen voertuigen kunnen worden gestationeerd, maar 10 bedden vanaf het begin',
            extensions:
                'Diverse specialisaties (in alle gevallen 7 Dagen, 70.000 Credits/15 Coins,  Interne Geneeskunde en Algemene Heelkunde slechts 10.000 Credits/10 Coins)',
            maxBuildings: 'Geen limiet',
            special:
                'Penningmeesters en Admins kunnen het Team Ziekenhuis met behulp van de credits van de Teamkas uitbreiden.',
        },
        rth: {
        ...
        pol: {
            ...
            maxBuildings: '1.100',
            special:
                'Vanaf het 25e opkomstbureau stijgen de kosten voor de bouw van een nieuw opkomstbureau volgens de volgende formule: <code>100.000+200.000*LOG<sub>2</sub>(Aantal opkomstbureaus − 22)</code>. De Coins prijs blijft constant!',
        },
        polschule: {
            ...
            startVehicle: 'Geen voertuigen stationeerbaar',
            extensions:
                'Tot 3 extra klaslokalen (in elk geval 7 dagen, 400.000 Credits/40 Coins)',
            maxBuildings: 'Geen limiet',
            special:
                'Penningmeesters en Admins kunnen de Team Politie Academie met behulp van de credits van de Teamkas uitbreiden.',
        },
        polheli: {
            ...
            extensions: 'Geen uitbreidingen mogelijk',
            special:
                'Er kunnen maximaal 4 landingsplaatsen per gebouw worden gebouwd. Tot het 125ste gebouw (van alle soorten) kunnen maximaal 4 landingsplaatsen worden gebouwd. Dan groeit het aantal met 1 per 25 gebouwen (vanaf 125.).',
        },
        psonder: {
            ...
            startVehicle: 'OvD-P',
            extensions:
                '2de OvD-P (3 Dagen, 40.000 Credits/5 Coins)<br>Mobiele Eenheid, Sectie (5 Dagen, 100.000 Credits/20 Coins)<br>Levende Have (7 Dagen, 100.000 Credits/20Coins)<br>Arrestatieteam (5 Dagen, 200.000 Credits/20 Coins)',
            maxBuildings: 'Geen limiet',
        },
    };
