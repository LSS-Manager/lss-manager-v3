...
//Alle Einsatz-IDs mit Stichwort-Zuweisung
    ...
    function missionKeyword() {
        //Stichwort Element
        var titleStichwort = document.getElementById('missionH1');
        
        //Anzahl Patientenbalken
        var anzahlPatients = document.getElementsByClassName("patient_progress").length;
        var aaoText = '';
        ...
        if(titleStichwort !== null && titleStichwort.innerText.toLowerCase().includes(I18n.t('lssm.missionKeywordDefaults.bmaLong').toLowerCase()))
        ...
        //Füge Label hinzu
        //titleStichwort.insertAdjacentHTML('afterbegin', '<b>:'+mission_id+':<font color="'+color+'">'+aaoText+'</font></b>');
        if(titleStichwort !== null)
            titleStichwort.insertAdjacentHTML('beforeend', '<span class="label '+label+'">'+aaoText+'</span>'+additionalAaoText);
    }
    missionKeyword();
})();
