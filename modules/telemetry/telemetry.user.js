...
</style><div class="lssm-modal-container" id="lssm-v4-modal-container"><div data-modal="dialog" aria-expanded="true" class="lssm-modal-overlay"><div class="lssm-modal-top-right-slot"></div></div> <div aria-expanded="true" role="dialog" aria-modal="true" class="lssm-modal-modal v--modal vue-dialog" style="top: 119px; left: 755px; width: 400px; height: auto;"><div class="dialog-content"><div class="dialog-c-title">${I18n.t('lssm.telemetry.v4.title')}</div> <div class="dialog-c-text">${I18n.t('lssm.telemetry.v4.content_till_beta')} <a class="lightbox-open" href="https://beta.lss-manager.de">https://beta.lss-manager.de</a> ${I18n.t('lssm.telemetry.v4.content_till_discord')} <a class="lightbox-open" href="https://discord.gg/RcTNjpB" target="_blank" >https://discord.gg/RcTNjpB</a> ${I18n.t('lssm.telemetry.v4.content_till_thread')} <a class="lightbox-open" target="_blank" href="https://forum.leitstellenspiel.de/index.php?thread/19176-lss-manager-v-4/">https://forum.leitstellenspiel.de/index.php?thread/19176-lss-manager-v-4/</a> ${I18n.t('lssm.telemetry.v4.content_end')} </div></div> <div class="vue-dialog-buttons"><button type="button" class="vue-dialog-button" style="flex: 1 1 100%;" id="lssm-v4-modal-close">${I18n.t('lssm.telemetry.v4.close')}</button></div> <!----></div></div>`;
